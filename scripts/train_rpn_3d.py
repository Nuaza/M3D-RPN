...
def main(argv):
    ...
    # 显示网络参数
    logging.info(summary(rpn_net, (3, 512, 1760), verbose=0, col_names=["kernel_size", "output_size", "num_params", "mult_adds"]))
    ...
    iter = 1
    training_bar = tqdm(total=conf.display, desc="Training " + str(iter) + "/" + str(int(conf.max_iter/conf.display)))
